...
```{r separate-all-trace, fig.cap='insert caption'}
#include_graphics("fig/sep_trace_ch1-10.pdf")
```
```{r separate-all-trace-density, fig.cap='insert caption'}
#include_graphics("fig/sep_trace_dens_ch1-10.pdf")
```

```{r separate-cogs-vs-phonotactics-all-data, fig.cap='Insert caption here. MCC trees from separate model. Cognates on left, phonotactics on right.'}
...
MLEs <- tibble(model = c("Linked", "Separate"),
               path = c(564009, 348287),
               stepping_stone = c(988213, 568402)
               )
